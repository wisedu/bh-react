...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactForms = __webpack_require__(158);
	...
	if (window.bhCallBack) window.bhCallBack(React, ReactDOM, ReactForms);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.assign === undefined) {
	  Object.assign = __webpack_require__(159);
	}

	var Form = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Form\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var Field = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Field\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var Fieldset = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Fieldset\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var RepeatingFieldset = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./RepeatingFieldset\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var Element = __webpack_require__(164);
	var Input = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Input\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var defaultValue = __webpack_require__(191);
	var ValidationResult = __webpack_require__(190);
	var FocusStore = __webpack_require__(193);
	...
	var Label = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Label\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var PropTypes = __webpack_require__(185);

	var messages = __webpack_require__(196);
	var schema = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./schema\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var Value = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./schema\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var ScalarNode = _require2.ScalarNode;
	var CompositeNode = _require2.CompositeNode;
	var ListNode = _require2.ListNode;
	...
	var Element = React.createClass({
	  ...
	  render: function render() {
	    var Component;
	    var node = this.props.value.node;

	    Component = node.props.get('component');
	    if (Component) {
	      return React.isValidElement(Component) ? cloneWithProps(Component, this.props) : React.createElement(Component, this.props);
	    } else {
	      if (node instanceof ListNode) {
	        Component = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./RepeatingFieldset\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	      } else if (node instanceof CompositeNode) {
	        Component = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Fieldset\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	      } else if (node instanceof ScalarNode) {
	        Component = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Field\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;'use strict';function _typeof(obj){return obj && typeof Symbol !== "undefined" && obj.constructor === Symbol?"symbol":typeof obj;} /**
	 ...
	 *  LICENSE file in the root directory of this source tree. An additional grant
	 *  of patent rights can be found in the PATENTS file in the same directory.
	 */(function(global,factory){( false?'undefined':_typeof(exports)) === 'object' && typeof module !== 'undefined'?module.exports = factory(): true?!(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):global.Immutable = factory();})(undefined,function(){'use strict';var SLICE$0=Array.prototype.slice;function createClass(ctor,superClass){if(superClass){ctor.prototype = Object.create(superClass.prototype);}ctor.prototype.constructor = ctor;} // Used for setting prototype methods that IE8 chokes on.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValueCtor = __webpack_require__(186);

	var _require = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./schema\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Schema = makePropType(function Schema(props, name, component) {
	  if (props[name] !== undefined && !(props[name] instanceof Node)) {
	    return new Error('Invalid Schema object passed as prop "' + name + '" to <' + component + ' />');
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var is = Immutable.is;
	var fromJS = Immutable.fromJS; // jshint ignore:line

	var emptyFunction = __webpack_require__(187);

	var _require = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./schema\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var ScalarNode = _require.ScalarNode;
	var CompositeNode = _require.CompositeNode;
	...
	var Value = (function () {
	  ...
	  _createClass(Value, [{
	    ...
	    value: function get(key) {
	      ...
	      invariant(abstractNode !== undefined, 'Access to key "%s" which does not exist in schema', key);
	      var value = this.value.get(key);
	      if (value == undefined) {
	        value = defaultValue(abstractNode);
	      }

	      var _abstractNode$instant = abstractNode.instantiate(value, undefined);

	      var node = _abstractNode$instant.node;
	      var value = _abstractNode$instant.value;

	      var externalValidation = this.externalValidation.has(key) ? this.externalValidation.get(key) : ValidationResult.success();
	      var validation = this.validation.has(key) ? this.validation.get(key) : value != undefined ? validate(node, value, ValidationResult.success()) : ValidationResult.success();
	      var serialized = this.serialized.has(key) ? this.serialized.get(key) : serialize(node, value);
	      var dirty = this.dirty.has(key) ? this.dirty.get(key) : this.isDirty ? DIRTY : EMPTY_MAP;
	    ...
	    value: function set(value) {
	      ...
	      var _abstractNode$instant2 = this.abstractNode.instantiate(value, this.node);

	      var node = _abstractNode$instant2.node;
	      var value = _abstractNode$instant2.value;
	    ...
	    key: 'transform',
	    value: function transform(updater) {
	      return this.set(updater(this.value));
	    }
	  }, {
	    key: 'setSerialized',
	    value: function setSerialized(serialized, options) {
	      options = options || {};
	      invariant(this.node instanceof ScalarNode, 'value should be a scalar');
	    ...
	    key: 'setExternalValidation',
	    value: function setExternalValidation(externalValidation) {
	      return this.__update({ externalValidation: externalValidation });
	    }
	  }, {
	    key: 'setSchema',
	    value: function setSchema(abstractNode) {
	      var _abstractNode$instant3 = abstractNode.instantiate(this.value, this.node);

	      var node = _abstractNode$instant3.node;
	      var value = _abstractNode$instant3.value;
	    ...
	    value: function notify() {
	      console.warn('Value: notify() method is deprecated, the onUpdate() callback ' + 'is now called automatically by each mutative method');
	    }
	  }, {
	    key: '__update',
	    value: function __update(attributes) {
	    ...
	    key: '__onUpdate',
	    value: function __onUpdate(child) {
	      var value = this.value.set(child.key, child.value);

	      var _abstractNode$instant4 = this.abstractNode.instantiate(value, this.node);

	      var node = _abstractNode$instant4.node;
	      var value = _abstractNode$instant4.value;
	      var dirty = _abstractNode$instant4.dirty;
	      ...
	      if (node.constructor !== this.node.constructor) {
	        ...
	        var childrenValidation = child.validation.isSuccess ? ValidationResult.children(this.validation.children.remove(String(child.key))) : ValidationResult.children(this.validation.children.set(String(child.key), child.validation));
	    ...
	    value: function __grow() {
	      if (this.node instanceof CompositeNode) {
	        ...
	        var _abstractNode$instant5 = this.abstractNode.instantiate(value, this.node);

	        var node = _abstractNode$instant5.node;
	        var value = _abstractNode$instant5.value;
	        var dirty = _abstractNode$instant5.dirty;

	        var childrenValidation = areChildrenValid ? ValidationResult.success() : new ValidationResult(null, children.map(function (c) {
	          return c.validation;
	        }).filter(function (v) {
	          return !v.isSuccess;
	        }));
	        var validation = validate(node, value, childrenValidation);
	        dirty = dirty ? dirty : this.dirty.merge(children.filter(function (c) {
	          return c.dirty.size > 0;
	        }).map(function (c) {
	          return c.dirty;
	        }));
	        var serialized = this.serialized.merge(children.map(function (c) {
	          return c.serialized;
	        }));
	        return this.__with({ node: node, value: value, validation: validation, dirty: dirty, serialized: serialized });
	      } else {
	    ...
	    key: '__with',
	    value: function __with(attributes) {
	      attributes = this.attributes.merge(attributes);
	      return new this.constructor(attributes, this.onUpdate, this.__root, this.keyPath);
	    }
	  }, {
	    key: 'root',
	    get: function get() {
	    ...
	    key: 'isValid',
	    get: function get() {
	      return this.attributes.get('validation').isSuccess && this.attributes.get('externalValidation', ValidationResult.success()).isSuccess;
	    }
	    ...
	    key: 'create',
	    value: function create(abstractNode, value, onUpdate, root) {
	      ...
	      var _abstractNode$instant6 = abstractNode.instantiate(value, undefined);

	      var node = _abstractNode$instant6.node;
	      var value = _abstractNode$instant6.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Immutable = __webpack_require__(165);
	var Map = Immutable.Map;
	var is = Immutable.is; // jshint ignore:line
	...
	var ValidationResult = (function () {
	  function ValidationResult(error, children) {
	    ...
	    this.error = error;
	    this.children = children ? Map(children).mapKeys(function (k) {
	      return String(k);
	    }) : EMPTY_MAP; // jshint ignore:line
	  }

	  _createClass(ValidationResult, [{
	    key: 'equals',
	    value: function equals(other) {
	      return other != null && // jshint ignore:line
	      is(this.error, other.error) && is(this.children, other.children);
	    }
	  }, {
	    key: 'get',
	    value: function get(key) {
	    ...
	    value: function children(_children) {
	      return new ValidationResult(null, _children);
	    }
	  }, {
	    key: 'success',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = _require.List; // jshint ignore:line

	var _require2 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./schema\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var MappingNode = _require2.MappingNode;
	var ListNode = _require2.ListNode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScopeMixin = {
	   ...
	   */
	  focusElement: function focusElement(keyPath) {
	...
	var FocusableMixin = {
	  ...
	  _getFocusScope: function _getFocusScope() {
	...
	var FocusStore = {
	  ...
	  registerScope: function registerScope(scopeComponent) {
	    var scopeID = getComponentFingerprint(scopeComponent);
	    state = state.set(scopeID, Immutable.Map());
	  },
	  unregisterScope: function unregisterScope(scopeComponent) {
	    var scopeID = getComponentFingerprint(scopeComponent);
	    state = state.remove(scopeID);
	  },
	  registerFocusable: function registerFocusable(scopeComponent, keyPath, focusableComponent) {
	    var key = keyPath.join('.');
	    var scopeID = getComponentFingerprint(scopeComponent);
	    state = state.update(scopeID, function (scope) {
	      return scope.set(key, focusableComponent);
	    });
	  },
	  unregisterFocusable: function unregisterFocusable(scopeComponent, keyPath, focusableComponent) {
	    var key = keyPath.join('.');
	    var scopeID = getComponentFingerprint(scopeComponent);
	    state = state.updateIn(scopeID, function (scope) {
	      return scope && scope.remove(key);
	    });
	  },
	  focusElement: function focusElement(scopeComponent, keyPath) {
	    var key = keyPath.join('.');
	    var scopeID = getComponentFingerprint(scopeComponent);
