...
var DialogWrap = (function (_React$Component) {
  ...
  _createClass(DialogWrap, [{
    ...
    value: function getDialogElement(extra) {
      ...
      var dialogProps = copy(props, ['className', 'closable', 'align', 'title', 'footer', 'mask', 'animation', 'transitionName',
                  'maskAnimation', 'maskTransitionName', 'mousePosition', 'prefixCls', 'style', 'width', 'height', 'zIndex',"type","content"]);
